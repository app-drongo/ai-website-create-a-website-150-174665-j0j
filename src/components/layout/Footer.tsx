  ...
  const footerSections = [
    {
      ...
      links: [
        ...
        { name: 'Service Templates', href: '/templates' },
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                Transforming business operations through innovative technology solutions. Trusted by
                industry leaders worldwide for reliable, scalable enterprise services.
              </p>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">contact@acmeco.com</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
              ...
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">456 Enterprise Blvd, Floor 12</span>
              </div>
            </div>

            {/* Newsletter Signup */}
            <div className="space-y-3">
              <h4 className="font-semibold text-sm">Industry Updates</h4>
              ...
              <p className="text-xs text-muted-foreground">
                Receive quarterly insights and product updates. Unsubscribe anytime.
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              <span>© 2024 Acme Co. All rights reserved.</span>
